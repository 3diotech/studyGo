...
class GeolocationStore {
  ...
  constQuestions = [
    { question: 'What is 1 + 1?', choices: ['5', '3', '6', '2'], answer: '2', tag: 'Math'},
    { question: 'Which one is a Primary Color?', choices: ['red', 'green', 'black', 'orange'], answer: 'red', tag: 'Science'},
    { question: 'What is the powerhouse of a cell?', choices: ['Cell Wall', 'Cytoplasm', 'Mitochondria', 'Ribosomes'], answer: 'Mitochondria', tag: 'Science'},
    { question: 'Which school did Harry Potter attended?', choices: ['CPU', 'Ateneo', 'Harvard', 'Hogwarts'], answer: 'Hogwarts', tag: 'Literature'},
    { question: 'Which big country is closest to New Zealand?', choices: ['Australia', 'China', 'US', 'Africa'], answer: 'Australia', tag: 'Geography'},
    { question: 'How many colours are in a rainbow?', choices: ['12', '9', '7', '4'], answer: '7', tag: 'Science'},
    { question: 'Pharaoh is the title given to the rulers of which ancient county?', choices: ['Russia', 'Egypt', 'Philippines', 'Singapore'], answer: 'Egypt', tag: 'History'},
    { question: 'How many years are there in a millennium?', choices: ['10', '100', '1000', '10000'], answer: '1000', tag: 'English'},
    { question: 'What is the name of the fairy in Peter Pan?', choices: ['Xayah', 'Lina', 'Miya', 'Tinkerbell'], answer: 'Tinkerbell', tag: 'Literature'},
  ]
  ...
  generateQuestion = () => {
    this.watchQuestions = setInterval(() => {
      if (this.listQuestions.length < 3) {
        ...
        newQuestion.setProperty('tag', question.tag)
