...
class Home extends Component {
  render() {
    ...
    const {
      ...
      navigation: { navigate },
      quizStore: { setCorrectAnswer, triggerAlert, alertVisible },
    ...
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity
          ...
          onPress={() => triggerAlert('COMMUNITY', `This group study is beign hosted by Cardo Dalisay, with the subject 'English'`)}
        >
          <Image
            resizeMode="contain"
            style={{
        ...
        <TouchableOpacity
          ...
          onPress={() => triggerAlert('COMMUNITY', `This group study is beign hosted by Mondragon, with the subject 'Math'`)}
        >
          <Image
            resizeMode="contain"
            style={{
